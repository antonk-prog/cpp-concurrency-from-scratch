...
|------|-----|-----------|--------------------|
| [8.1. Параллельный for_each](labs/lab-08-01-parallel-for-each/task.md) | напиши с нуля | средняя | реализуй `parallel_for_each`: блоки, `packaged_task`, свой `join_threads` |
| [8.2. Неатомарный флаг остановки](labs/lab-08-02-find-done-flag/task.md) | найди и почини | средняя | почини гонку за флаг «найдено» в параллельном `find` |
| [8.3. Конкуренция за общий счётчик](labs/lab-08-03-shared-counter-contention/task.md) | нагрузочный вопрос | сложная | объясни и почини деградацию параллельного инкремента общего счётчика |